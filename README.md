myclementine.py - shows current track played in Clementine, unlike the original clementine.py script, mine uses newer dbus syntax so it works in modern systems
